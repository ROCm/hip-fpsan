...
template __global__ void wmma_kernel<Semantics::Triton>(const _Float16*, const _Float16*, float*);
template __global__ void wmma_kernel<Semantics::Field>(const _Float16*, const _Float16*, float*);
template __global__ void wmma_kernel<Semantics::Field2>(const _Float16*, const _Float16*, float*);
template __global__ void
    wmma_kernel<Semantics::FieldFast>(const _Float16*, const _Float16*, float*);
template __global__ void
    wmma_kernel<Semantics::FieldFast2>(const _Float16*, const _Float16*, float*);
template __global__ void
    wmma_kernel<Semantics::FieldWithMulCasts>(const _Float16*, const _Float16*, float*);
template __global__ void
    wmma_kernel<Semantics::FieldWithMulCasts2>(const _Float16*, const _Float16*, float*);
template __global__ void
    wmma_kernel<Semantics::SophieGermainRing>(const _Float16*, const _Float16*, float*);
template __global__ void
    wmma_kernel<Semantics::SophieGermainRing2>(const _Float16*, const _Float16*, float*);
template __global__ void
    wmma_kernel<Semantics::PythagoreanRing>(const _Float16*, const _Float16*, float*);
template __global__ void
    wmma_kernel<Semantics::PythagoreanRing2>(const _Float16*, const _Float16*, float*);
